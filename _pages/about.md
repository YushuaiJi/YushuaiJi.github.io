...
<ol class="pub-list">
  <li>
    ...
    <span class="paper-title" data-lang="zh" hidden><a href="https://www.vldb.org/pvldb/vol19/p808-zhu.pdf">具有个体公平性的大规模高效 k-means。</a></span><br>
  ...
  <li>
    ...
    <span class="paper-title" data-lang="zh" hidden><a href="https://arxiv.org/abs/2603.01598">统一多模型数据库中的图中心跨模型数据集成与分析。</a></span><br>
  ...
  <li>
    ...
    <span class="paper-title" data-lang="zh" hidden><a href="https://sheng.whu.edu.cn/papers/26icde.pdf">面向快速端侧搜索的可更新平衡索引与自动选择模型。</a></span><br>
...
<ol class="pub-list">
  <li>
    ...
    <span class="paper-title" data-lang="zh" hidden><a href="https://sheng.whu.edu.cn/papers/25vldb.pdf">面向高维数据的联邦平衡聚类。</a></span><br>
  ...
  <li>
    ...
    <span class="paper-title" data-lang="zh" hidden><a href="https://www.computer.org/csdl/proceedings-article/icde/2025/360300a863/26FZzBgQACY">大规模空间向量简化：快速、节省内存且成本可预测的 k-means。</a></span><br>
